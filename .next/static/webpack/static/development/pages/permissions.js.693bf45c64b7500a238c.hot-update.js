...
function (_React$Component) {
  ...
  function UserPermissions() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePermissionChange", function (e) {
      ...
      console.log(checkbox.value); //take a copy of the current permissions

      var updatedPermissions = _toConsumableArray(_this.state.permissions); // figure out if we need to remove this permission.
...
//# sourceMappingURL=permissions.js.693bf45c64b7500a238c.hot-update.js.map